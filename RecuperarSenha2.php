		...
		<div class="menor ajust ">
			...
			<form>
				...
				<div class="form-group">
					...
					<input type="password" class="form-control" id="exampleInputPassword2" name="" placeholder="Password">
				</div>
			</form>	
		</div>
		<div class="B">
			<a href="AEP"><button  type="button" class="btn bt">Cancelar</button></a>
			<a href="AEP"><button type="button" class="btn botao ">Confirmar</button></a>
		</div>		
	</div>
</body>
</html>
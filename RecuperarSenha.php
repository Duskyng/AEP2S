...
<body>
	...
	<div class="maior">
		...
		<div class="aviso">
			<h4>Um link será enviado para o email informado.</h4>				
		</div>
		<div class="menor ajust ">

			<form>
				<div class="form-group">
					<label for="exampleFormControlInput1">*Insira o email cadastrado para redefinir sua senha</label>
		...
		<div class="B">
			<a href="AEP"><button  type="button" class="btn bt">Cancelar</button></a>
			<a><button type="button" class="btn botao ">Confirmar</button></a>
		</div>		
	</div>
</body>
</html>